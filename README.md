...
A [complete list](https://github.com/NKulling/SWECO25/blob/main/data/SWECO25_datalayers_details.csv) describing each of the 5,265 layers is available in this repository. The SWECO25 database is openly available on Zenodo and is intended to be improved, updated, and extended at regular intervals.
...
<p align='center'>
  <img src='https://img.shields.io/badge/Downloads-143-blue' alt='Downloads Badge'>
  <img src='https://img.shields.io/badge/Views-1415-blue' alt='Views Badge'>
</p>
